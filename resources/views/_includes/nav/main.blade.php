  ...
  <div class="container">
    <div class="nav-left">
      <a class="nav-item is-paddingless" href="{{route('home')}}">
        <img src="{{asset('images/logo-icon.png')}}" alt="StudyChoice"><span class="logo is-primary m-r-100">StudyChoice</span>
      </a>
      ...
      <a href="/" class="nav-item is-tab is-hidden-mobile ">Back to Site</a>
    </div>
    ...
    <div class="nav-right nav-menu" style="overflow: visible">
      ...
      <a class="nav-item is-tab is-hidden-tablet ">Site</a>
      @if (Auth::guest())
        <a href="{{route('login')}}" class="nav-item is-tab">Login</a>
        <a href="{{route('register')}}" class="nav-item is-tab">Join Portal</a>
      @else
